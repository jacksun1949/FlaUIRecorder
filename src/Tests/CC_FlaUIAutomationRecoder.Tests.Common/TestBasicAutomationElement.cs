...
using CC_FlaUIAutomationRecoder.Tests.Common.Converters;
using FlaUI.UIA2.Extensions;
using CC_FlaUIAutomationRecoder.Tests.Common.EventHandlers;
using FlaUI.UIA2.Identifiers;
using CC_FlaUIAutomationRecoder.Tests.Common.Patterns;

namespace CC_FlaUIAutomationRecoder.Tests.Common
{
