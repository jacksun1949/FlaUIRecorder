...
using CC_FlaUIAutomationRecoder.CodeProvider.CSharp;
...
namespace CC_FlaUIAutomationRecoder
{
    ...
    public class TestReport
    {
        ...
        private string BuildHtml()
        {
            ...
            sb.AppendLine(""<title>CC_FlaUIAutomationRecoder Test Report</title>"");
            ...
            sb.AppendFormat(""  <h1>CC_FlaUIAutomationRecoder Test Report</h1>\n"");
            ...
            sb.AppendFormat(""<div class=\""footer\"">CC_FlaUIAutomationRecoder &mdash; {0} steps executed in {1:F1}s</div>\n"", Passed + Failed, duration);
            sb.AppendLine(""</body>"");
            sb.AppendLine(""</html>"");
